        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <ul class="navbar-nav mr-auto justify-center items-center lg:flex">
                    ...
                    <li class="nav-item">
                    <a class="page-scroll" href="{{route('user/monitoringbreedingpets')}}">Monitoring Breeding</a>
                    </li>
                </ul>
                <div class="border-t border-gray-200"></div>
                                ...
                                <div class="lg:w-1/4 sm:w-1/2 p-2 border-4 border-gray-200">
                                    <div class="flex relative">
                                        ...
                                        <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                                            ...
                                            <a href= "{{route('user/monitoringpets', ['id'=>$item->id])}}" class="text-indigo-600 hover:text-indigo-900 mr-3">Lihat Monitoring</a>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
